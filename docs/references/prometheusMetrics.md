...
| `teranode_validator_size_tiered_fee_rejections` | Counter | Transactions rejected by the minminingtxfeebysize policy                |
| `teranode_validator_size_tiered_fee_consolidation_exemptions` | Counter | Underpaying transactions accepted as free consolidations by the minminingtxfeebysize policy |
